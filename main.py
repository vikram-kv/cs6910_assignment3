...
def gen_parser():
    ...
    parser.add_argument('-hs', '--hidden_size', dest='hidden_size', default=256, type=int, help='common hidden state size in encoder and decoder')
    ...
    parser.add_argument('-dr', '--dropout', dest='dropout', default=0.0, type=float, help='dropout probability in dropout layers')
    parser.add_argument('-itr', '--initial_tf_ratio', dest='initial_tf_ratio', default=0.7, type=float, help='Initial value of teacher-forcing ratio to be used in our tf ratio scheduler')
    parser.add_argument('-bs', '--batch_size', dest='batch_size', default=128, type=int, help='Batch size to be used during training and validation')
